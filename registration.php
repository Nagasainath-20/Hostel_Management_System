...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
     ...
     $conn= mysqli_connect('localhost','root','','hostel') or die("Connection failed:" .mysqli_connect_error());
      ...
      <form action="registration.php"   method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your regno" name="regno" value="<?php echo "$regno"; ?>" pattern="[0-9]{2}[A-Z]{3}[0-9]{1}[A-Z]{1}[0-9]{2}" required>
          </div>
          <div class="input-box">
