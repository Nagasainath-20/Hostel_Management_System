...
<div class="wrapper">
	<div class="search_box">
		<input type="text" name="regno" id="regno" class="input_search" placeholder="Enter student regno" pattern="[0-9]{2}[A-Z]{3}[0-9]{1}[A-Z]{1}[0-9]{2}">
...
<tbody>
  ...
  $sql="SELECT name,regno,email,phoneno,block,roomno FROM user WHERE regno='$regno';";
